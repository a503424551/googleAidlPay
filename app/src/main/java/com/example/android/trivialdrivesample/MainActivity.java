...
public class MainActivity extends Activity implements IabBroadcastListener,
    ...
    //static final String SKU_GAS = "4";
    static  String SKU_GAS = BuildConfig.PRODUCT_ID;
    //static final String SKU_GAS = "diary_gift_3";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        //     String base64EncodedPublicKey = "";
           String base64EncodedPublicKey = BuildConfig.GOOGLE_PAY_KEY;
        ...
        try {
            mHelper.queryInventoryAsync(true, skuList, null, new IabHelper.QueryInventoryFinishedListener() {
                ...
                public void onQueryInventoryFinished(IabResult result, Inventory inv) {
                    Log.d(TAG, "queryInventoryAsync==="+inv.getmSkuMap().size());
                    Toast.makeText(MainActivity.this,inv.getSkuDetails(SKU_GAS).getSku(),1).show();
                }
            });
        } catch (IabAsyncInProgressException e) {
            e.printStackTrace();
